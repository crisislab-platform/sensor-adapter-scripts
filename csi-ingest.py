...
class MyClient(EasySeedLinkClient):
    ...
    def on_data(self, trace):
        ...
        # if(len(data) == 200):
        udp_sender(trace.stats.channel, timestamp, trace.data)
...
if __name__ == "__main__":
    while True:
        try:
            # Define the SeedLink server parameters
            server_ip = '192.168.100.100'  # Replace with the IP address of your SeedLink server
            server_port = 18000  # Replace with the port number of your SeedLink server
            ...
            client.select_stream("SS", "DEM2", "HN?")
            client.run()
